def tokenize_inst(inst):
    ...
    if registers != '':
        ...
        tokens += registers
    tokens.append("</INST>")
    if opcode == "19": return [] # ignore COPY instr
    return tokens
...
bb_tokens_pre, bb_tokens_post = tokenized_format("hw2correct1.c.txt")
# bb_tokens_pre, bb_tokens_post = tokenized_format("spill.c.txt")
# print_tokens(bb_tokens_pre)
# print_tokens(bb_tokens_post)
print(bb_tokens_pre)
